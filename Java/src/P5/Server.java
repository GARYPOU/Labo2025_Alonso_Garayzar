...
public class Server {
    private static List<SocketAddress> clientes = new ArrayList<>();
    private static Map<SocketAddress, Boolean> ackRecibidos = new HashMap<>();
    private static Map<SocketAddress, PublicKey> clavesPublicasClientes = new HashMap<>();
    ...
    private static int clientesEsperados = 2;
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            String className = Server.class.getSimpleName().toLowerCase(); // cambia según la clase
        ...
        try {
            ...
            PUERTO_SERVIDOR = Integer.parseInt(props.getProperty("server.port", String.valueOf(PUERTO_SERVIDOR)));
            clientesEsperados = Integer.parseInt(props.getProperty("server.expectedClients", String.valueOf(clientesEsperados)));
